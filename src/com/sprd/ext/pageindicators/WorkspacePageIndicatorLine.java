 ...
 */
public class WorkspacePageIndicatorLine extends WorkspaceBasePageIndicator {
    ...
    private static final Property<WorkspacePageIndicatorLine, Integer> PAINT_ALPHA
            = new Property<WorkspacePageIndicatorLine, Integer>(Integer.class, "paint_alpha") {
        @Override
        public Integer get(WorkspacePageIndicatorLine obj) {
            return obj.mLinePaint.getAlpha();
        }

        @Override
        public void set(WorkspacePageIndicatorLine obj, Integer alpha) {
            obj.mLinePaint.setAlpha(alpha);
            obj.invalidate();
        }
    };

    private static final Property<WorkspacePageIndicatorLine, Float> NUM_PAGES
            = new Property<WorkspacePageIndicatorLine, Float>(Float.class, "num_pages") {
        @Override
        public Float get(WorkspacePageIndicatorLine obj) {
            return obj.mNumPagesFloat;
        }

        @Override
        public void set(WorkspacePageIndicatorLine obj, Float numPages) {
            obj.mNumPagesFloat = numPages;
            obj.invalidate();
        }
    };

    private static final Property<WorkspacePageIndicatorLine, Integer> TOTAL_SCROLL
            = new Property<WorkspacePageIndicatorLine, Integer>(Integer.class, "total_scroll") {
        @Override
        public Integer get(WorkspacePageIndicatorLine obj) {
        ...
        @Override
        public void set(WorkspacePageIndicatorLine obj, Integer totalScroll) {
    ...
    public WorkspacePageIndicatorLine(Context context) {
        this(context, null);
    }

    public WorkspacePageIndicatorLine(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WorkspacePageIndicatorLine(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setShouldAutoHide(boolean shouldAutoHide) {
        super.setShouldAutoHide(shouldAutoHide);
